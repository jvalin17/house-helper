...
echo ""
echo "  Building House Helper desktop app..."
echo ""
...
cp backend/dist/house-helper-backend "src-tauri/binaries/house-helper-backend-${ARCH}"
ok "Backend binary: src-tauri/binaries/house-helper-backend-${ARCH}"
